...
const authenticate = async () => {
    ...
    try {
        ...
        const response = await httpClient.post(starwsConfig.endpoints.auth, qs.stringify(starwsConfig.authParams), headers, starwsConfig.urlAuth);
...
const isTokenExpired = () => {
    ...
    const renewTokenInMinute = starwsConfig.renewTokenInMinute; // should renew token in minute
